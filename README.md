-- ==========================================
-- LUX HUB v2.0 (FIX & STABLE)
-- ==========================================

-- 1. LIMPEZA DE VERSÕES ANTIGAS (Evita bugs)
local Players = game:GetService("Players")
local LocalPlayer = Players.LocalPlayer
if LocalPlayer:WaitForChild("PlayerGui"):FindFirstChild("LuxHub_v2.0_Stable") then
	LocalPlayer.PlayerGui.LuxHub_v2.0_Stable:Destroy()
end
...
ScreenGui.Name = "LuxHub_v2.0_Stable"
ScreenGui.ResetOnSpawn = false
ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Global
ScreenGui.Parent = LocalPlayer:WaitForChild("PlayerGui")

print("Lux Hub: GUI Criada!") -- Debug no F9
...
-- EFEITOS E LOADING
-- ==========================================
-- Removemos o Blur do Lighting para evitar travar se o jogo não permitir
...
-- ==========================================
-- BOTÃO LX (COM VERIFICAÇÃO DE SEGURANÇA)
-- ==========================================
local OpenBtn = Instance.new("TextButton")
OpenBtn.Name = "OpenButton"
OpenBtn.Size = UDim2.new(0, 55, 0, 55)
OpenBtn.Position = UDim2.new(0, 5, 0.25, 0) -- Posição Fixa Esquerda
...
-- ==========================================
-- ABA STATUS (FIXED - SEM HTTP CRASH)
-- ==========================================
...
local RegionLabel = CreateStatLabel("Region: N/A") -- Desativado para evitar crash
...
RunService.RenderStepped:Connect(function()
	if StatusPage.Visible then
		TimeLabel.Text = "Date: " .. os.date("%H:%M:%S")
		...
		else HealthLabel.Text = "Health: N/A" end
		...
		local pingVal = Stats.Network.ServerStatsItem["Data Ping"]:GetValueString(); local ping = math.floor(pingVal:split(" ")[1])
...
tw.Completed:Connect(function() task.wait(0.5)
	LoadingContainer:Destroy()
	OpenBtn.Visible = true
	print("Lux Hub: Carregamento Concluído")
end)

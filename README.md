...
local function CreateTab(name, pageToShow)
    ...
    Btn.TextSize = 17 -- DEFINIDO COMO 17
...
local function AddToggle(text, callback)
    ...
    L.TextSize = 17 -- DEFINIDO COMO 17
...
Hop.TextSize = 17 -- DEFINIDO COMO 17

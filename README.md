...
ScreenGui.Name = "LuxHub_V13_FixedClick"
...
DragBar.Size = UDim2.new(0, 120, 0, 12)
DragBar.Position = UDim2.new(0.5, -60, 0, 8)
...
-- Brilho (Glow) acoplado diretamente ao botão
...
TweenService:Create(Glow, TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true), {ImageTransparency = 0.7, Size = UDim2.new(1.3, 0, 1.3, 0), Position = UDim2.new(-0.15, 0, -0.15, 0)}):Play()
...
-- --- INTERIOR (SIDEBAR E CONTEÚDO) ---
local SideBar = Instance.new("Frame")
SideBar.Size = UDim2.new(0, 140, 0, 270); SideBar.Position = UDim2.new(0, 10, 0, 40)
...
MainContent.Size = UDim2.new(0, 350, 0, 270); MainContent.Position = UDim2.new(0, 160, 0, 40)
...
AddToggle("Speed Active", UDim2.new(0.05, 0, 0, 75), function(v) Settings.SpeedActive = v end)

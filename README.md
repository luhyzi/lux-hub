...
ScreenGui.Name = "LuxHub_Luiz"
ScreenGui.ResetOnSpawn = false
ScreenGui.IgnoreGuiInset = true -- Melhora compatibilidade com mobile
...
SideBar.Size = UDim2.new(0, 130, 1, -40); SideBar.Position = UDim2.new(0, 10, 0, 20)
SideBar.BackgroundColor3 = Color3.fromRGB(30, 30, 30); SideBar.Parent = Background
...
MainContent.Size = UDim2.new(1, -160, 1, -40); MainContent.Position = UDim2.new(0, 150, 0, 20)
MainContent.BackgroundColor3 = Color3.fromRGB(30, 30, 30); MainContent.Parent = Background
Instance.new("UICorner", MainContent)

local Credits = Instance.new("TextLabel")
Credits.Text = "v 1.3 luiz"; Credits.Font = "GothamBold"; Credits.TextSize = 12
Credits.TextColor3 = Color3.fromRGB(150, 150, 150); Credits.Position = UDim2.new(1, -75, 0, 10)
Credits.Size = UDim2.new(0, 70, 0, 20); Credits.BackgroundTransparency = 1; Credits.Parent = MainContent
...
OpenLogo.BackgroundColor3 = Color3.fromRGB(20, 20, 20); OpenLogo.Visible = true; OpenLogo.Parent = ScreenGui
...
local function AddToggle(name, pos, callback)
    ...
    TFrame.Size = UDim2.new(0.9, 0, 0, 40); TFrame.Position = pos; TFrame.BackgroundColor3 = Color3.fromRGB(20,20,20); TFrame.Parent = MainContent
    ...
    Btn.MouseButton1Click:Connect(function()
        state = not state
        Btn.BackgroundColor3 = state and Color3.new(0,1,0) or Color3.new(0,0,0)
        callback(state)
    end)
end

AddToggle("Esp", UDim2.new(0.05, 0, 0, 40), function(v) Settings.ESP = v end)
AddToggle("Speed", UDim2.new(0.05, 0, 0, 90), function(v) Settings.SpeedActive = v end)

-- VELOCIDADE
local SpeedInput = Instance.new("TextBox")
SpeedInput.Size = UDim2.new(0, 80, 0, 35); SpeedInput.Position = UDim2.new(0.05, 0, 0, 140)
...
Pronto.Text = "Pronto"; Pronto.Size = UDim2.new(0, 100, 0, 35); Pronto.Position = UDim2.new(0.4, 0, 0, 140)
...
print("Lux Hub Luiz carregado com sucesso!")

...
local Colors = {
	...
	Text = Color3.fromRGB(200, 200, 200),       -- Texto Cinza
	TextSelected = Color3.fromRGB(255, 255, 255), -- Texto Branco
	Accent = Color3.fromRGB(160, 100, 255)
}

-- GUI PRINCIPAL
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "LuxHub_TopButton"
ScreenGui.ResetOnSpawn = false
ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Global
ScreenGui.Parent = LocalPlayer:WaitForChild("PlayerGui")

-- ==========================================
-- 1. TELA DE LOADING (ANIMADA)
-- ==========================================
...
-- ==========================================
-- 2. BOTÃO REDONDO (AGORA NO TOPO)
-- ==========================================
local OpenBtn = Instance.new("ImageButton")
OpenBtn.Name = "OpenButton"
OpenBtn.Size = UDim2.new(0, 55, 0, 55)
-- POSIÇÃO ALTERADA: Topo Centralizado (0.05 de distância do topo)
OpenBtn.Position = UDim2.new(0.5, -27, 0.05, 0) 
...
-- ==========================================
-- 3. JANELA PRINCIPAL (COM ANIMAÇÃO DE ABRIR)
-- ==========================================
...
MainFrame.ClipsDescendants = true -- Para animação ficar limpa
...
-- Lógica de Animação (Abrir/Fechar)
local isOpen = false
OpenBtn.MouseButton1Click:Connect(function()
	if isOpen then
		-- Fechar (Animação de encolher)
		...
		-- Abrir (Animação de crescer - Pop Up)
		MainFrame.Visible = true
		MainFrame.Size = UDim2.new(0, 0, 0, 0)
		MainFrame.BackgroundTransparency = 0
		-- Centraliza antes de crescer para crescer do meio
		-- Mas como o AnchorPoint é 0,0, vamos manter a posição e animar o Size, o ClipDescendants cuida do resto
		-- Ajuste para crescer do centro visualmente (simulado)
		...
		local openTweenPos = TweenService:Create(MainFrame, TweenInfo.new(0.5, Enum.EasingStyle.Elastic, Enum.EasingDirection.Out), {Position = UDim2.new(0.5, -240, 0.5, -150)})
...
Title.BackgroundTransparency = 1; Title.TextXAlignment = Enum.TextXAlignment.Center; Title.Parent = Sidebar
...
SubVer.Position = UDim2.new(0, 0, 0, 45)
SubVer.BackgroundTransparency = 1; SubVer.TextXAlignment = Enum.TextXAlignment.Center; SubVer.Parent = Sidebar
	...
	local function Refresh()
		...
		for _,p in pairs(Players:GetPlayers()) do
			if p ~= LocalPlayer then
				...
				b.MouseButton1Click:Connect(function()
					for _, other in pairs(List:GetChildren()) do if other:IsA("TextButton") then other.TextColor3 = Colors.Text end end
					b.TextColor3 = Colors.TextSelected; Settings.TargetPlayer = p; Ready.Text = "Ready"
				end)
			end
		end
	end
...
tw.Completed:Connect(function()
	task.wait(0.5); LoadingFrame:Destroy(); OpenBtn.Visible = true
end)
